...
docred_rel2id = json.load(open('meta/rel2id_polymer.json', 'r'))
cdr_rel2id = {'1:NR:2': 0, '1:CID:2': 1}
#gda_rel2id = {'1:NR:2': 0, '1:GDA:2': 1}
gda_rel2id = {'1:NR:2': 0, '1:has_property:2': 1, '1:has_value:2': 2, '1:has_amount:2': 3, '1:has_condition:2': 4, '1:synthesised_by:2': 5, '1:characterized_by:2': 6, '1:abbreviation_of:2': 7, '1:refers_to:2': 8}
        ...
        for i_l, line in enumerate(tqdm(lines)):
            ...
            if pmid not in pmids:
                ...
                for p in prs:
                    ...
                    r = gda_rel2id[p[0]]
                    if (h_id, t_id) not in train_triples:
                        train_triples[(h_id, t_id)] = [{'relation': r, 'label': p[0]}]
                    else:
                        train_triples[(h_id, t_id)].append({'relation': r, 'label': p[0]})
