...
#             if debug:
#                 print(f"{char} vs {original_text[current_original_idx+1]} ")
#             if char == original_text[current_original_idx+1]:
#                 if debug:
#                     print("increase current_original_idx")
#                 current_original_idx += 1
#         if debug:
#             print(f"save mapping_dict with idx key is {idx} and value is {current_original_idx}")
