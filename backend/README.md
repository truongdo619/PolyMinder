...
pip install sqlalchemy python-jose
```


#### 2. Download pretrained models
cd PDF  
A pretrained NER model is provided for inference. Download from this [URL](https://drive.google.com/drive/folders/1dsoae6AOPXOV0tLwK3t2gya6Sf7Zi6rd?usp=sharing) and put it in ```./NER/pretrained_models```.

A pretrained RE model is provided for inference. Download from this [URL](https://drive.google.com/drive/folders/1Btm2KyzI0K1sOx12TryHDxhhX2Ktu7Vm?usp=sharing) and put it in ```./RE/pretrained_models``.
