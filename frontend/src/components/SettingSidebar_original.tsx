    ...
    const sortedRelationOccurrences = Object.keys(relationTypeOccurrences)
      ...
      const handleSummarize = async () => {
        ...
        try {
          ...
          // TODO: specific API call to summarize the document
          // const token = localStorage.getItem('accessToken');
...
{/* ────────────── REVISED SUMMARY DIALOG (HARDCODED WITH EXPLANATIONS) ────────────── */}
      <Dialog
        ...
        <DialogTitle sx={{ m: 0, p: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Box>
            ...
            <Typography variant="caption" color="text.secondary">
              Overview of the extracted data, entities, and relationships found in your document.
            </Typography>
          </Box>
          <IconButton aria-label="close" onClick={handleSummaryDialogClose} sx={{ color: (theme) => theme.palette.grey[500] }}>
            <CloseIcon />
          </IconButton>
        </DialogTitle>
        <Divider />
        ...
        <DialogContent sx={{ p: 3, backgroundColor: '#f9f9f9' }}>
          ...
          <Paper elevation={0} sx={{ p: 3, mb: 3, border: '1px solid #e0e0e0', borderRadius: 2 }}>
             <Box sx={{ mb: 2 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                    High-level metrics indicating the volume and structure of the processed content.
                </Typography>
             </Box>
             ...
             <Grid container spacing={3}>
                ...
                <Grid item xs={6} md={3}>
                    <Box sx={{ p: 2, bgcolor: '#e8f5e9', borderRadius: 2, textAlign: 'center' }}>
                        ...
                        <Typography variant="h5" fontWeight="bold">12,500</Typography>
                        <Typography variant="caption" color="text.secondary">Total extracted words</Typography>
                    </Box>
                </Grid>
                <Grid item xs={6} md={3}>
                    <Box sx={{ p: 2, bgcolor: '#fff3e0', borderRadius: 2, textAlign: 'center' }}>
                        ...
                        <Typography variant="caption" color="text.secondary">Data tables found</Typography>
                    </Box>
                </Grid>
                <Grid item xs={6} md={3}>
                    <Box sx={{ p: 2, bgcolor: '#f3e5f5', borderRadius: 2, textAlign: 'center' }}>
                        <ImageIcon color="secondary" sx={{ fontSize: 30, mb: 1 }} />
                        <Typography variant="h5" fontWeight="bold">8</Typography>
                        <Typography variant="caption" color="text.secondary">Images processed</Typography>
                    </Box>
                </Grid>
             </Grid>
          </Paper>
                ...
                <Paper elevation={0} sx={{ p: 3, height: '100%', border: '1px solid #e0e0e0', borderRadius: 2 }}>
                    <Box sx={{ mb: 2 }}>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <Typography variant="subtitle2" sx={{ bgcolor: '#e3f2fd', color: '#1976d2', px: 1, borderRadius: 1 }}>
                                Total: 1,240
                            </Typography>
                        </Box>
                        <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
                            Distribution of the most frequent entity types detected.
                        </Typography>
                    </Box>
                    ...
                    <Box sx={{ maxHeight: 300, overflowY: 'auto', pr: 1 }}>
                        {[
                          { label: 'Polymer', count: 450, desc: 'Chemical structures' },
                          { label: 'Property', count: 300, desc: 'Physical attributes' },
                          { label: 'Method', count: 200, desc: 'Synthesis techniques' },
                          { label: 'Value', count: 290, desc: 'Numerical data' }
                        ].map((item) => (
                            <Box key={item.label} sx={{ mb: 2 }}>
                                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.5 }}>
                                    ...
                                    <Typography variant="body2" color="text.secondary" fontWeight="bold">{item.count}</Typography>
                                </Box>
                                <BorderLinearProgress 
                                    variant="determinate" 
                                    value={(item.count / 1240) * 100 * 1.5} 
                                    sx={{ 
                                        [`& .${linearProgressClasses.bar}`]: { backgroundColor: '#2196F3' } 
                                    }}
                                />
                            </Box>
                        ))}
                ...
                <Paper elevation={0} sx={{ p: 3, height: '100%', border: '1px solid #e0e0e0', borderRadius: 2 }}>
                    <Box sx={{ mb: 2 }}>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <Typography variant="subtitle2" sx={{ bgcolor: '#f3e5f5', color: '#9c27b0', px: 1, borderRadius: 1 }}>
                                Total: 980
                            </Typography>
                        </Box>
                        <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
                            How entities are connected within the text.
                        </Typography>
                    </Box>
                    ...
                    <Box sx={{ maxHeight: 300, overflowY: 'auto', pr: 1 }}>
                         {[
                          { label: 'has_property', count: 400, desc: 'Links polymers to properties' },
                          { label: 'synthesized_by', count: 300, desc: 'Links to methods' },
                          { label: 'has_value', count: 280, desc: 'Links properties to values' }
                        ].map((item) => (
                            <Box key={item.label} sx={{ mb: 2 }}>
                                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.5 }}>
                                    <Box>
                                ...
                                <BorderLinearProgress 
                                    variant="determinate" 
                                    value={(item.count / 980) * 100 * 1.5} 
                                    sx={{ 
                                        [`& .${linearProgressClasses.bar}`]: { backgroundColor: '#9C27B0' } 
                                    }}
                                />
                            </Box>
                        ))}
          ...
          <Paper elevation={0} sx={{ mt: 9, p: 3, border: '1px solid #e0e0e0', borderRadius: 2, overflow: "hidden" }}>
             <Box sx={{ mb: 2 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                    Interactive visualization of the extracted network. Click on any node to expand its connections and explore the data structure.
                </Typography>
             </Box>
             <Divider sx={{ mb: 2 }} />
             <SummerizeGraph documentId={documentId} updateId={updateId} initialTopK={5} />
          </Paper>
