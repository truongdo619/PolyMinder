    ...
    <div className="sidebar" style={{ width: "100%", height: "100vh", overflowY: "auto" }}>
      <div className="description" style={{ padding: "1rem" }}>
        ...
        <p style={{ fontSize: "15px", marginTop: "10px" }}>
          📝 If the tables seem out of order, you can{" "}
          <span
            style={{
              color: "#007bff",
              cursor: "pointer",
            ...
            >
              <div style={{ flex: 1, width: '100%' }}>
                ...
                {highlight.content.image && (
                  <div className="highlight__image__container" style={{ marginTop: "0.3rem" }}>
                    <img
      ...
      <Dialog open={openEdit} onClose={handleCloseEdit} maxWidth="md">
        <DialogTitle sx={{ textAlign: "center" }}>
          Edit Text - Table {currentHighlight ? (currentHighlight.para_id ?? 0) + 1 : ''}
        </DialogTitle>
        <Divider />
        <DialogContent>
          <Textarea
      ...
      <Dialog open={openReorder} onClose={handleCloseReorder} maxWidth="md" fullWidth>
        <DialogTitle sx={{ textAlign: "center" }}>Reorder Tables</DialogTitle>
        <Divider />
                    ...
                    >
                      {(provided: DraggableProvided, snapshot: DraggableStateSnapshot) => (
                        <Tooltip key={highlight.id} title={highlight.content.text} arrow>
                          ...
                          >
                            <div>
                              <strong>Table {(highlight.para_id ?? 0) + 1}</strong>:{" "}
